  ...
  export const columns: ColumnDef<Clientes>[] = [
    {
      ...
      accessorFn: (row) => {
        const nombres = row.nombres || ""; // Si el nombre es null o undefined, usa una cadena vacía
        const apellidoPaterno = row.apellido_paterno || ""; // Lo mismo para apellido paterno
        const apellidoMaterno = row.apellido_materno || ""; // Lo mismo para apellido materno
  
        // Concatenar solo los valores que no sean cadenas vacías
        const fullName = `${nombres} ${apellidoPaterno} ${apellidoMaterno}`;
  
        // Elimina los espacios innecesarios si los apellidos son nulos
